...
const env = {
  ...
  hlsWindowSegments: parseNumber(process.env.HLS_WINDOW_SEGMENTS, 6),
  sessionTtlMs: parseNumber(process.env.SESSION_TTL_MS, 10 * 60 * 1000),
  videoCodec: process.env.VIDEO_CODEC || 'libx264',
  videoProfile: process.env.VIDEO_PROFILE || 'baseline',
